...
async function main() {
    ...
    console.log('Connecting to Render WebSocket URL:', wsUrl);
    ...
    ws.on('open', async () => {
        ...
        fs.writeFileSync('/Users/sergiovalle/.gemini/antigravity-ide/brain/9e75d83a-a66c-4bae-8cc7-6d0a96f25627/render_screenshot.png', buffer);
        console.log('Screenshot saved to render_screenshot.png');
        ws.close();
    });
}
