...
async function main() {
    ...
    ws.on('open', async () => {
        console.log('Connected to cPanel tab via CDP');
        ...
        fs.writeFileSync('/Users/sergiovalle/.gemini/antigravity-ide/brain/9e75d83a-a66c-4bae-8cc7-6d0a96f25627/cpanel_screenshot.png', buffer);
        console.log('Screenshot saved to cpanel_screenshot.png');
        ws.close();
    });
}
