...
async function main() {
    ...
    ws.on('open', async () => {
        ...
        const appRootUrl = 'https://server402.web-hosting.com:2083/cpsess3768607345/frontend/jupiter/filemanager/index.html?dir=/home/layumpnx/whatsapp-microservice';
        console.log('Navigating File Manager to whatsapp-microservice...');
        await send('Page.navigate', { url: appRootUrl });
        ...
        fs.writeFileSync('/Users/sergiovalle/.gemini/antigravity-ide/brain/9e75d83a-a66c-4bae-8cc7-6d0a96f25627/cpanel_app_files.png', Buffer.from(screenshot.data, 'base64'));
        console.log('Screenshot saved to cpanel_app_files.png');

        // Check text for log files or error files
