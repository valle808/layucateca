...
async function main() {
    ...
    ws.on('open', async () => {
        ...
        console.log('Navigating back to selector page:', selectorUrl);
        ...
        const clickResult = await send('Runtime.evaluate', {
            expression: `
                (function() {
                    ...
                    if (restartBtn) {
                        restartBtn.click();
                        return 'Clicked RESTART button successfully!';
                    }
        ...
        console.log('Screenshot saved to cpanel_restart_completed.png');
