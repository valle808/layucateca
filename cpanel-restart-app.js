...
async function main() {
    ...
    ws.on('open', async () => {
        ...
        const clickResult = await send('Runtime.evaluate', {
            expression: `
                (function() {
                    ...
                    const restartBtn = btns.find(b => b.innerText && b.innerText.trim().toUpperCase() === 'RESTART');
                    if (restartBtn) {
                        restartBtn.click();
        ...
        fs.writeFileSync('/Users/sergiovalle/.gemini/antigravity-ide/brain/9e75d83a-a66c-4bae-8cc7-6d0a96f25627/cpanel_node_app_restarted.png', Buffer.from(screenshot.data, 'base64'));
        console.log('Screenshot saved to cpanel_node_app_restarted.png');
