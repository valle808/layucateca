...
export const defaultSkills: AgentSkill[] = [
  ...
  { id: 's9', name: 'LLM App Orchestrator', description: { es: 'Diseño y despliegue de aplicaciones y agentes autónomos multi-LLM', en: 'Design and deployment of multi-LLM autonomous apps and agent workflows', my: 'Nu\'ukbesajil LLM apps' }, category: 'Cognition', agentIds: ['muna-ai'], enabled: true, usageCount: 2470 },
  { id: 's10', name: 'Neural & Transformer Architecture Specialist', description: { es: 'Ingeniería avanzada en redes de atención, x-transformers y modelos de visión', en: 'Advanced engineering in attention networks, x-transformers, and vision models', my: 'Xook Transformer architecture' }, category: 'Cognition', agentIds: ['muna-ai'], enabled: true, usageCount: 1890 },
  { id: 's11', name: 'Bioinformatics & AlphaFold 3 Integration', description: { es: 'Análisis molecular y simulación de plegamiento de proteínas tridimensionales', en: 'Molecular analysis and three-dimensional protein folding simulation', my: 'Xook AlphaFold 3' }, category: 'Bioinformatics', agentIds: ['muna-ai'], enabled: true, usageCount: 940 },
  { id: 's12', name: 'Generative Diffusion & Text-to-Image Expert', description: { es: 'Modelado y síntesis generativa por difusión e Imagen-pytorch', en: 'Generative diffusion modeling and synthesis via Imagen-pytorch', my: 'Generative Diffusion Expert' }, category: 'Cognition', agentIds: ['muna-ai'], enabled: true, usageCount: 1530 },
  { id: 's13', name: 'Multimodal Transfusion & Vector Quantization', description: { es: 'Modelado conjunto de texto e imágenes por discretización de vectores', en: 'Joint text and image modeling via vector-quantized discretization', my: 'Multimodal Transfusion' }, category: 'Cognition', agentIds: ['muna-ai'], enabled: true, usageCount: 1120 },
  { id: 's14', name: 'Ollama Model Orchestration', description: { es: 'Conexión y ejecución de modelos locales privados de la Ollama Library', en: 'Connection and execution of local private models from the Ollama Library', my: 'Ollama Model Orchestration' }, category: 'Systems', agentIds: ['muna-ai'], enabled: true, usageCount: 3240 }
];
